...
parser.add_argument('-m', '--trained_model', default='magface_iresnet18_casia_dp.pth',
                    type=str, help='Trained state_dict file path to open')
parser.add_argument('--arch', default='iresnet18', help='Backbone network mobile0.25 or resnet50')
